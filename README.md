...
For [TDSM](https://flinkerflitzer.itch.io/tdsm), five sheet styles have been added in this module to support this generator. When exporting, use the default sequencing and layout (horizontal animation orientation, and don't check `multiple animations per row`).

You can use the `TDSM Time Elements Mini Style` for Time Elements sheets that only have walk and idle animations.
